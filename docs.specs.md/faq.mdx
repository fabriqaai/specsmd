...
<AccordionGroup>
  <Accordion title="What is specs.md?">
    ...
    - **FIRE Flow** - Rapid execution for solo/small teams (0-2 adaptive checkpoints)
    - **AI-DLC Flow** - Full methodology with DDD for teams and complex domains

    [Choose your flow →](/architecture/choose-flow)
  </Accordion>

  <Accordion title="Which flow should I choose?">
    | Flow | Best For | Checkpoints |
    |------|----------|-------------|
    | **Simple** | Quick specs, prototypes, handoff to other teams | 3 (phase gates) |
    | **FIRE** | Solo/small teams, brownfield, monorepos | 0-2 (adaptive) |
    | **AI-DLC** | Teams, complex domains, regulated environments | 10-26 |

    **Quick decision:**
    - Just need specs without execution tracking? → **Simple**
    - Solo or small team, want to ship fast? → **FIRE**
    - Team with complex domain, need full traceability? → **AI-DLC**
  ...
  <Accordion title="What is FIRE flow?">
    ...
    - **Inspired by AI-DLC**: Keeps intents, structured execution, human validation
    - **Adaptive checkpoints**: 0-2 based on complexity (vs AI-DLC's 10-26)
