...
<Info>
**Available Now**: [specs.md (Simple Flow)](/simple-flow/overview) provides Spec Kit and Kiro-like simple flows for developers who want a lighter entry point before adopting full AI-DLC workflows.
</Info>
...
| **[specs.md (Simple Flow)](/simple-flow/overview)** | Available | Simpler projects without complex trade-off management |
...
| **[Simple Flow](/simple-flow/overview)** | Available | Kiro-style Requirements → Design → Tasks workflow |
