...
❯ FIRE - Rapid execution for solo/small teams (0-2 checkpoints)
  AI-DLC - Full methodology with DDD (10-26 checkpoints)
```

| Flow | Best For | Agents |
|------|----------|--------|
| **Simple** | Quick specs, prototypes, handoff | 1 |
| **FIRE** | Solo/small teams, brownfield, monorepos | 3 |
| **AI-DLC** | Teams, complex domains, full lifecycle | 4 |
