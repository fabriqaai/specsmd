...
<AccordionGroup>
  ...
  <Accordion title="Use the glossary">
    Define domain terms in the glossary and use them consistently. This helps the agent maintain consistent language throughout the specs.
  </Accordion>
