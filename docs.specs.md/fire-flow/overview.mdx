...
graph LR
    subgraph "Autopilot (0 checkpoints)"
        A1[Plan] --> A2[Implement] --> A3[Test] --> A4[Review] --> A5[Walkthrough]
    end
    ...
    style A4 fill:#34D399,stroke:#10B981,color:#fff
    style A5 fill:#34D399,stroke:#10B981,color:#fff
```
*Zero stops. AI burns through.*

```mermaid
graph LR
    subgraph "Confirm (1 checkpoint)"
        C1[Plan] --> C2{{"✋ Approve Plan?"}} --> C3[Implement] --> C4[Test] --> C5[Review] --> C6[Walkthrough]
    end
    ...
    style C5 fill:#818CF8,stroke:#6366F1,color:#fff
    style C6 fill:#818CF8,stroke:#6366F1,color:#fff
```
*One stop before coding.*

```mermaid
graph LR
    subgraph "Validate (2 checkpoints)"
        V1[Design] --> V2{{"✋ Approve Design?"}} --> V3[Plan] --> V4{{"✋ Approve Plan?"}} --> V5[Implement] --> V6[Test] --> V7[Review] --> V8[Walkthrough]
    end
    ...
    style V7 fill:#8B5CF6,stroke:#7C3AED,color:#fff
    style V8 fill:#8B5CF6,stroke:#7C3AED,color:#fff
```
*Two stops. Design review, then plan approval.*
